...
d3.csv(url).then(function(data) {
    ...
    console.log(data)
        ...
        var xMax = d3.max(data, d => parseInt(d.dokter))
        console.log(xMax)
        ...
        .attr("y", d => y(d.negara))
        .attr("width", d => x(d.dokter))
        .attr("height",y.bandwidth())
        .on("mouseover",function(d) {            
            tooltip
            .html("<strong>" + d.negara + "</strong>" + "<br>" + d3.format(",.2r")(d.dokter))
            //
            d3
            .select(this)
            .style("stroke","black")
        ...
        .style("fill","black")
        .attr("x", d => x(d.dokter)+lefttransform+5)
        .attr("y", d => y(d.negara)+10)
        .text(function(d) { return d3.format(",.2r")(d.dokter)})  
