...
function page1() {
    story
        .html("Sejak kasus pertama di 28 Februari 2020, Pemerintah Selandia Baru telah melakukan berbagai kebijakan. "
        + "Pada 17 Maret turis asing dipulangkan dengan protokol karantina ketat, dan Kementerian Keuangan mengeluarkan "
        + "bantuan finansial untuk berbagai sektor terdampak langsung.")
}

function page2() {
    story
        .html("Kepedulian dan kejelasan tindakan pemerintah berdampak langsung, pada setiap ada peningkatan tingkat <i>lockdown</i>, "
        +"grafik jumlah orang yang berada di <span class='dot-home1'><b>rumah</b></span> meningkat drastis. Apabila jumlah orang yang di rumah menurun dikarenakan "
        +"pelonggaran <i>lockdown</i> yang dilakukan pemerintah.")
}

function page3() {
    story
        .html("Dalam rentang 25 Maret (tingkat 4) hingga 27 April (tingkat 3) terjadi penurunan jumlah kasus secara drastis. "
        + "Hingga 9 Agustus grafik terlihat relatif datar, tercatat pada tanggal tersebut sudah 100 hari tidak ada kasus baru dalam <i>community transmission<i>.")
}
