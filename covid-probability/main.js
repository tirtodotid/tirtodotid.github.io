...
function sampling() {
    ...
    document.getElementById('title').innerHTML = '<span class="highlight">' + prob + '</span> dari <span class="highlight">10.000 </span> orang<br>di <span class="highlight">'+ opt.text +'</span> positif<br> terjangkit Covid-19<br><span class="thin">(30 Agustus 2020)</span>' 
